 ...
 */
export class ShootArcRotateCameraPointersInput extends ShootBaseCameraPointersInput {
  /**
  ...
  private _computePinchZoom(
    ...
    const radius =
      this.camera.radius ||
      ShootArcRotateCameraPointersInput.MinimumRadiusForPinch;
    ...
    if (this.multiTouchPanAndZoom) {
      ...
      if (
        ...
        (this._twoFingerActivityCount < 20 &&
          Math.abs(
            Math.sqrt(pinchSquaredDistance) -
              Math.sqrt(previousPinchSquaredDistance)
...
(CameraInputTypes as any)[
  "ShootArcRotateCameraPointersInput"
] = ShootArcRotateCameraPointersInput;
